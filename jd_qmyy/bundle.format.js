(function () {
...
})()(
  {
            ...
            return __awaiter(this, void 0, void 0, function* () {
              for (let i = 0; i < this.starIdArr.length; i++) {
                yield new Promise((resolve) => {
                  ...
                  utils_1.default.outPutLog(
                    this.outputTextarea,
                    `当前明星：${starId}`
                  );
                  fetch(
                    `https://urvsaggpt.m.jd.com/guardianstar/getHomePage?t=${new Date().getTime()}&starId=${starId}`
                  )
                    .then((res) => res.json())
                    .then((json) =>
    ...
    2: [
      function (require, module, exports) {
        ...
        class Stall {
          constructor(containerDiv, outputTextarea) {
            ...
            this.secretp = "";
            this.inviteUrl =
              "https://bunearth.m.jd.com/babelDiy/Zeus/4SJUHwGdUQYgg94PFzjZZbGZRjDd/index.html?shareType=homeTask&inviteId=";
            this.groupInvitedUrl =
              "https://bunearth.m.jd.com/babelDiy/Zeus/4SJUHwGdUQYgg94PFzjZZbGZRjDd/index.html?shareType=cbdDay&inviteId=";
                ...
                if (this.data) {
                  ...
                  for (let j = 0; j < this.data.taskVos.length; j++) {
                    value += `\n${this.taskVos[j]["taskName"]}：${
                      this.data.taskVos[1]["status"] == 2 ? "已完成" : "未完成"
          ...
          <button class="city" style="width: 120px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;color:#fff;margin:5px auto;display:block">城市版图任务</button>
            ...
            this.container.appendChild(content);
            const signIn = utils_1._$(".signIn"),
              others = utils_1._$(".others"),
              group = utils_1._$(".group"),
              master = utils_1._$(".master"),
              steal = utils_1._$(".steal"),
              help = utils_1._$(".help"),
              funny = utils_1._$(".funny"),
              viewProduct = utils_1._$(".viewProduct"),
              city = utils_1._$(".city"),
              shopping = utils_1._$(".shopping"),
              invite = utils_1._$(".invite"),
              goodShopping = utils_1._$(".goodShopping"),
              timer = utils_1._$(".timer"),
              deliver = utils_1._$(".deliver"),
              raise = utils_1._$(".raise"),
              collect = utils_1._$(".collect"),
              browser = utils_1._$(".browser"),
              assistGroup = utils_1._$(".assistGroup"),
              helpGroup = utils_1._$(".helpGroup"),
              assist = utils_1._$(".assist"),
              auto = utils_1._$(".auto"),
              treasure = utils_1._$(".treasure"),
              addproduct = utils_1._$(".addproduct");
            ...
            goodShopping.addEventListener("click", () =>
              __awaiter(this, void 0, void 0, function* () {
                this.doTask(
                  16,
                  `开始自动逛逛好物会场任务`,
          ...
          single(taskId, itemId) {
            return new Promise((reslove) => {
              ...
              let postData = {
                taskId: taskId,
                itemId: itemId,
                ss: `{\"extraData\":${this.getExtraData(
                  extraData
                )},\"businessData\":{\"taskId\":${taskId},\"rnd\":\"${
                  extraData["data"]["rnd"]
                }\",\"inviteId\":\"-1\",\"stealId\":\"-1\"},\"secretp\":\"${
                  this.secretp
                }\"}`,
                shopSign: "",
              };
              utils_1.default
                .request("stall_collectScore", postData)
                .then((res) => {
                  utils_1.default.outPutLog(
                    this.outputTextarea,
                    res.data.bizMsg
          ...
          collect() {
            return new Promise((reslove) => {
              ...
              let postData = {
                ss: `{\"extraData\":${this.getExtraData(
                  extraData
                )},\"businessData\":{\"taskId\":\"collectProducedCoin\",\"rnd\":\"${
                  extraData["data"]["rnd"]
                }\",\"inviteId\":\"-1\",\"stealId\":\"-1\"},\"secretp\":\"${
                  this.secretp
                }\"}`,
              ...
              utils_1.default
                .request("stall_collectProduceScore", postData)
                .then((res) => {
                  utils_1.default.outPutLog(
                    this.outputTextarea,
                    "领取金币:" + res.data.result.produceScore
                  );
                  reslove();
                });
            });
                    ...
                    .then((res) =>
                      __awaiter(this, void 0, void 0, function* () {
                        ...
                        for (let i = 0; i < length; i++) {
                          let city = shopList[i],
                            shopSign = city["shopId"];
                          utils_1.default.outPutLog(
                            self.outputTextarea,
                            `任务城市进度：${i + 1}/${length}当前任务城市：${
                              city["name"]
                            }`
                          );
                          ...
                          yield new Promise((resolve) => {
                            utils_1.default
                              .request("stall_getTaskDetail", postData)
                              .then((result) =>
                                __awaiter(this, void 0, void 0, function* () {
                                    ...
                                    if (taskVo["status"] == 2) {
                                      ...
                                      yield new Promise((resolveFn) => {
                                        ...
                                        setTimeout(
                                          ...
                                          config_1.default.timeoutSpan +
                                            utils_1.default.random(300, 500)
                                        );
                                      });
                                    }
                                  }
          ...
          getItemIdByName(task, name, taskId) {
            ...
            if (taskId == 1) {
              ...
              let shop = task[VoName].filter((shopVo) => {
                return (
                  shopVo["shopName"] == task["taskName"] ||
                  shopVo["subtitle"] == task["taskName"]
                );
              })[0];
                            ...
                            utils_1.default
                              ...
                              .then(() =>
                                __awaiter(this, void 0, void 0, function* () {
                                  ...
                                  yield utils_1.default.sleep(
                                    8000 + utils_1.default.random(300, 500)
                                  );
                                  let extraData = {
                                    id: "jmdd-react-smash_74",
                                    data: {
                  ...
                  for (let i = 0; i < length; i++) {
                    ...
                    yield new Promise((resolve) =>
                      __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield utils_1.default
                          .request("stall_getFeedDetail", postData)
                          .then((res) =>
                            __awaiter(this, void 0, void 0, function* () {
                              utils_1.default.outPutLog(
                                this.outputTextarea,
                              ...
                              for (let j = 0; j < totalCounter; j++) {
                                let productInfoVos =
                                    res.data.result.viewProductVos[i]
                                      .productInfoVos,
                                  productInfoVo = productInfoVos[j],
                                  taskId =
                                    res.data.result.viewProductVos[i]["taskId"];
                                yield new Promise((resolveFn) =>
                                  __awaiter(this, void 0, void 0, function* () {
                                    yield utils_1.default.sleep(
                      ...
                      yield utils_1.default
                        ...
                        .then((res) =>
                          __awaiter(this, void 0, void 0, function* () {
                            ...
                            for (let j = 0; j < totalCounter; j++) {
                              let productInfoVos =
                                  res.data.result.addProductVos[i]
                                    .productInfoVos,
                                productInfoVo = productInfoVos[j],
                                taskId =
                                  res.data.result.addProductVos[i]["taskId"];
                              yield new Promise((resolveFn) =>
                                __awaiter(this, void 0, void 0, function* () {
                                  yield utils_1.default.sleep(
                                    5000 + utils_1.default.random(300, 500)
          ...
          steal() {
            return __awaiter(this, void 0, void 0, function* () {
              utils_1.default
                .request("stall_pk_getStealForms", {})
                .then((res) =>
                  __awaiter(this, void 0, void 0, function* () {
                      ...
                      yield new Promise((resolve) => {
                        setTimeout(
                          () =>
                            __awaiter(this, void 0, void 0, function* () {
                              utils_1.default
                                .request("stall_pk_doSteal", postData)
                                .then((res) =>
                                  __awaiter(this, void 0, void 0, function* () {
                                    utils_1.default.outPutLog(
                                      self.outputTextarea,
          ...
          openTreasure() {
            return __awaiter(this, void 0, void 0, function* () {
              ...
              utils_1.default
                .request("qryCompositeMaterials", {
                  qryParam:
                    '[{"type":"advertGroup","mapTo":"homeFeedBanner","id":"04891279"},{"type":"advertGroup","mapTo":"homeBottomBanner","id":"04888981"},{"type":"advertGroup","mapTo":"homeBottomBanner2","id":"04958033"}]',
                      ...
                      yield new Promise((resolve) => {
                        setTimeout(
                          () =>
                            __awaiter(this, void 0, void 0, function* () {
                              utils_1.default
                                .request("stall_shopSignInWrite", postData)
                                .then((res) =>
                                  __awaiter(this, void 0, void 0, function* () {
                                    utils_1.default.outPutLog(
                                      this.outputTextarea,
                          ...
                          __awaiter(this, void 0, void 0, function* () {
                            if (once) {
                              ...
                              if (res.data.result) {
                                ...
                                utils_1.default
                                  .request("qryViewkitCallbackResult", {
                                    clientLanguage: "zh",
                                    dataSource: "newshortAward",
                                    method: "getTaskAward",
                                    reqParams: `{\"taskToken\":\"${res.data.result.taskToken}\"}`,
          ...
          raise() {
            utils_1.default.request("stall_raise").then((res) => {
              if (res.data.bizCode == 0) {
                utils_1.default.outPutLog(
                  this.outputTextarea,
                  `操作成功！获取奖励如下:${JSON.stringify(
                    res.data.result.levelUpAward
                  )}`
                );
              } else {
                utils_1.default.outPutLog(
                  this.outputTextarea,
                  `操作失败！${res.data.bizMsg}`
                );
              }
            });
          }
          getInvite() {
            utils_1.default
              .request("stall_getTaskDetail", { shopSign: "" })
              .then((res) => {
                const inviteId = res.data.result.inviteId.replace("#/", "");
                if (inviteId) {
                  utils_1.default.outPutLog(
                    this.outputTextarea,
                    `获取到邀请地址:${this.inviteUrl}${inviteId}`
                  );
          ...
          help() {
            ...
            let InviteIdArr = [
              "Vl4ISIBiRXIGKK019Wz4ZTtSKSmSrl3eryon7Oj99HniIJIparURjK0",
              "S18jDI0sSSEYbNhQ0B7KYk_Jt49K1g",
            ];
            this.assist(
              this.inviteUrl +
                InviteIdArr[0]
          ...
          helpGroup(flag = true) {
            if (new Date().getHours() >= 9) {
              ...
              let inviteUrl =
                this.groupInvitedUrl +
                InviteIdArr[utils_1.default.random(0, InviteIdArr.length - 1)];
              this.assistGroup(inviteUrl, flag);
            }
          }
          group() {
            utils_1.default.request("stall_pk_getHomeData").then((res) => {
              const groupAssistInviteId =
                res.data.result.groupInfo.groupAssistInviteId;
              if (groupAssistInviteId) {
                utils_1.default.outPutLog(
                  this.outputTextarea,
                  `获取到邀请地址:${this.groupInvitedUrl}${groupAssistInviteId}`
                );
                utils_1.default.copyText(
                  `${this.groupInvitedUrl}${groupAssistInviteId}`
                );
              } else {
                utils_1.default.outPutLog(
                  this.outputTextarea,
          ...
          assistGroup(url, flag = true) {
            ...
            const inviteId = utils_1.default
              .getSearchString(url, "inviteId")
              .replace("#/", "");
            let extraData = {
              id: "jmdd-react-smash_0",
              data: {
            ...
            let postData = {
              ...
              ss: `{\"extraData\":${this.getExtraData(
                ...
                extraData["data"]["rnd"]
              }\",\"inviteId\":\"${inviteId}\",\"stealId\":\"-1\"},\"secretp\":\"${
                this.secretp
              }\"}`,
            };
            utils_1.default
              .request("stall_pk_assistGroup", postData)
              .then((res) => {
                if (flag) {
                  utils_1.default.outPutLog(
                    this.outputTextarea,
          ...
          assist(url) {
            ...
            const inviteId = utils_1.default
              ...
              .replace("#/", "");
            utils_1.default
              .request("stall_getHomeData", { inviteId: inviteId })
              .then((res) => {
                let extraData = {
                  id: "jmdd-react-smash_0",
                  data: {
          ...
          getExtraData(args) {
            return JSON.stringify(
              Object.assign(smashUtils.get_info(args)["data"], {
                buttonid: args["id"],
                sceneid: "homePageh5",
                appid: "50073",
              })
      ...
      { "../config/config": 5, "../utils/utils": 30 },
    ],
    3: [
      function (require, module, exports) {
        "use strict";
        ...
        class StarMall {
          ...
          get() {
            return __awaiter(this, void 0, void 0, function* () {
              utils_1.default
                .clientPost("mcxhd_starmall_getStarShopPage", {
                  token: this.token,
                })
                .then((res) => {
          ...
          doTask(shopId) {
            utils_1.default
              .clientPost("mcxhd_starmall_taskList", {
                shopId: shopId,
                token: this.token,
              })
              .then((res) =>
                __awaiter(this, void 0, void 0, function* () {
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[0].subItem[0].itemId,
                      taskType: "1",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[1].subItem[0].itemId,
                      taskType: "2",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[2].subItem[0].itemId,
                      taskType: "4",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[2].subItem[1].itemId,
                      taskType: "4",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[2].subItem[2].itemId,
                      taskType: "4",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[2].subItem[3].itemId,
                      taskType: "4",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[2].subItem[4].itemId,
                      taskType: "4",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[3].subItem[0].itemId,
                      taskType: "4",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[4].subItem[0].itemId,
                      taskType: "6",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[5].subItem[0].itemId,
                      taskType: "5",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[6].subItem[0].itemId,
                      taskType: "5",
                      shopId: shopId,
                      token: this.token,
                    })
                  ...
                  utils_1.default
                    .clientPost("mcxhd_starmall_doTask", {
                      itemId: this.data[7].subItem[0].itemId,
                      taskType: "3",
                      shopId: shopId,
                      token: this.token,
                    })
      ...
      function (require, module, exports) {
        ...
        class TimeMachine {
          constructor(containerDiv, outputTextarea) {
            ...
            this.inviteUrl =
              "https://h5.m.jd.com/babelDiy/Zeus/3DDunaJMLDamrmGwu73QbqtGtbX1/index.html?babelChannel=ttt4&inviteId=";
            this.ePin = "";
          ...
          updateTask() {
            return new Promise((reslove) => {
              utils_1.default
                .publicRequest("bc_taskList", this.position)
                .then((res) => {
                  this.data = res.data.result;
                  if (this.data) {
                    ...
                    for (let j = 0; j < this.taskVos.length; j++) {
                      value += `\n${this.taskVos[j]["mainTitle"]}：${
                        this.taskVos[j]["isCompleted"] ? "已完成" : "未完成"
                      }(${this.taskVos[j]["taskProgress"]})`;
                    }
                    utils_1.default.outPutLog(this.outputTextarea, value);
                  }
                  reslove();
          ...
          <button class="play" style="width: 120px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;color:#fff;margin:5px auto;display:block">套圈圈领能量</button>
            ...
            this.container.appendChild(content);
            const signIn = utils_1._$(".signIn"),
              shopping_big = utils_1._$(".shopping_big"),
              help = utils_1._$(".help"),
              funny = utils_1._$(".funny"),
              collect = utils_1._$(".collect"),
              place = utils_1._$(".place"),
              shopping = utils_1._$(".shopping"),
              shopping_super = utils_1._$(".shopping_super"),
              invite = utils_1._$(".invite"),
              timer = utils_1._$(".timer"),
              raise = utils_1._$(".raise"),
              visit = utils_1._$(".visit"),
              play = utils_1._$(".play"),
              assist = utils_1._$(".assist"),
              market = utils_1._$(".market"),
              auto = utils_1._$(".auto");
            auto.addEventListener("click", () => {
              this.autoDoTask();
            });
            ...
            shopping_super.addEventListener("click", () =>
              __awaiter(this, void 0, void 0, function* () {
                this.doTask(1, `开始逛“超级”品牌店铺任务`);
              })
            );
            shopping_big.addEventListener("click", () =>
              __awaiter(this, void 0, void 0, function* () {
            ...
            play.addEventListener("click", () =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                yield this.repeatTask({}, 10, "bc_getGameReward", {
                  score: 200,
                });
              })
            );
            ...
            return __awaiter(this, void 0, void 0, function* () {
              ...
              return new Promise((reslove) =>
                __awaiter(this, void 0, void 0, function* () {
                  ...
                  yield utils_1.default
                    .publicRequest("bc_doTask", postData)
                    .then((res) =>
                      __awaiter(this, void 0, void 0, function* () {
                        if (res.data.result) {
                          utils_1.default.outPutLog(
                            this.outputTextarea,
                            `操作成功！获得能量${
                              res.data.result.energy ||
                              res.data.result.rewardEnergy
                            }`
                          );
                        } else {
                          utils_1.default.outPutLog(
          ...
          collect() {
            return new Promise((reslove) => {
              utils_1.default
                .publicRequest("bc_collectEnergyBall", {})
                .then((res) => {
                  if (res.data.success) {
                    utils_1.default.outPutLog(
                      this.outputTextarea,
                      "领取能量:" + res.data.result.energy
                    );
                  } else {
                    utils_1.default.outPutLog(
                      this.outputTextarea,
                      "领取能量:" + res.data.bizMsg
                    );
                  }
                  reslove();
                });
                    ...
                    .then((res) =>
                      __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (res.data.result) {
                          utils_1.default.outPutLog(
                            this.outputTextarea,
                            `操作成功！获得能量${res.data.result.energy}`
                          );
                        }
                      })
                    )
            ...
            return new Promise((next) =>
              __awaiter(this, void 0, void 0, function* () {
                for (let i = 0; i < times; i++) {
                  ...
                  yield utils_1.default
                    .publicRequest(url || "bc_doTask", postData)
                    .then((res) =>
                      __awaiter(this, void 0, void 0, function* () {
                        utils_1.default.outPutLog(
                          this.outputTextarea,
          ...
          raise() {
            utils_1.default.publicRequest("bc_fragmentCharge").then((res) => {
              if (res.data.bizCode == 0) {
                utils_1.default.outPutLog(
                  this.outputTextarea,
                  `操作成功！返回信息:${JSON.stringify(res.data.result)}`
                );
              } else {
                utils_1.default.outPutLog(
                  this.outputTextarea,
                  `操作成功！返回信息:${JSON.stringify(res.data.bizMsg)}`
                );
              }
            });
          }
          getInvite() {
            utils_1.default.outPutLog(
              this.outputTextarea,
              `获取到邀请地址:${this.inviteUrl}${this.ePin}`
            );
          ...
          assist(url) {
            ...
            const inviteId = utils_1.default
              ...
              .replace("#/", "");
            utils_1.default
              .publicRequest("bc_doTask", { taskType: 8, invitePin: inviteId })
              .then((res) => {
                utils_1.default.outPutLog(
                  this.outputTextarea,
                  `助力结果：${res.data.bizMsg}`
    ...
    5: [
      function (require, module, exports) {
        ...
        Config.JDUserInfoURL =
          "https://wq.jd.com/user/info/QueryJDUserInfo?sceneid=11110&sceneval=2&g_login_type=1";
        Config.JDTimeInfoURL =
          "https://api.m.jd.com/client.action?functionId=babelActivityGetShareInfo&client=wh5";
        Config.JDIMGSourcesURL = "https://img13.360buyimg.com/n1/s450x450_";
        Config.NetdiskURL =
          "链接：https://pan.baidu.com/s/17eyRRSrFUQVSKdYwIcDsHg 提取码：jddk ";
              ...
              setTimeout(
                () =>
                  __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield fetch_jsonp_1.default
                      .fetchJsonp(config_1.default.JDUserInfoURL)
                      ...
                      .then((res) => {
                        if (res.base.nickname) {
                          utils_1.default.outPutLog(
                            output,
                            `【${ckObj.mark}】:京东账号->${res.base.nickname}`
                          );
                          resolve(true);
                        } else {
                          utils_1.default.outPutLog(
                            output,
                            `【${ckObj.mark}】:该ck校验失败，请检查有效性!`
                          );
                          resolve(false);
                        }
                      });
      ...
      function (require, module, exports) {
        ...
        class CoinPurchase {
          constructor(couponParams, containerDiv, outputTextarea) {
            this.url =
              "https://vip.jr.jd.com/goldcoin/purchase?id={pid}&callback=";
            this.detailurl =
              "https://vip.jr.jd.com/goldcoin/goods/{pid}?callback=";
            this.couponList = [];
          ...
          list() {
            const content = document.createElement("div");
            content.innerHTML =
              "<h3 style='border-bottom: 1px solid #2196F3;display: inline-block;margin-top: 5px;padding: 0 37.5vw 5px;'>优惠券</h3>";
            content.setAttribute(
              "style",
              "display:flex;flex-direction:column;padding: 5px;margin-top: 5px;border: 1px solid #000;"
            );
            for (let i = 0; i < this.couponList.length; i++) {
              ...
              itemDiv.setAttribute(
                "style",
                "display:flex;flex-direction:row;padding:10px 0;border-bottom:1px solid #999"
              );
      ...
      function (require, module, exports) {
        ...
        class Exchange {
          constructor(couponParams, containerDiv, outputTextarea) {
            ...
            this.detailurl =
              "https://vip.m.jd.com/fuli/detail.html?itemId={itemId}";
            this.couponList = [];
            this.couponParams = couponParams;
            this.container = containerDiv;
            this.outputTextarea = outputTextarea;
          ...
          get() {
            this.couponList = [];
            let url = this.detailurl.replace(
              "{itemId}",
              this.couponParams.itemId
            );
          ...
          list() {
            ...
            for (let i = 0; i < this.couponList.length; i++) {
              ...
              itemDiv.setAttribute(
                "style",
                "padding:10px 0;border:1px solid gray;border-radius: 10px;margin-top:5px;padding: 5px"
              );
        ...
        class GcConvert {
          constructor(couponParams, containerDiv, outputTextarea) {
            this.url =
              "https://vip.jr.jd.com/goldcoin/purchase?id={pid}&callback=";
            this.detailurl =
              "https://ms.jr.jd.com/gw/generic/hy/h5/m/gateFloorById?reqData={%22floorId%22:44,%22pageChannel%22:%22spike%22}";
            this.couponList = [];
            this.couponParams = couponParams;
            this.container = containerDiv;
            this.outputTextarea = outputTextarea;
                  ...
                  for (let i = 0; i < data.length; i++) {
                    ...
                    if (coupon) {
                      this.couponList.push({
                        ...
                        exchangeStatus:
                          coupon.exchangeStatus == 3
                            ? "已抢光"
                            : coupon.exchangeStatus == 2
                            ? "已领取"
                            : "可领取",
          ...
          list() {
            const content = document.createElement("div");
            content.innerHTML =
              "<h3 style='border-bottom: 1px solid #2196F3;display: inline-block;margin-top: 5px;padding: 0 37.5vw 5px;'>优惠券</h3><p style='margin: 5px 0;color:red'>请先点击列表项选择领取的券</p>";
            content.setAttribute(
              "style",
              "display:flex;flex-direction:column;padding: 5px;margin-top: 5px;border: 1px solid #000;"
            );
            for (let i = 0; i < this.couponList.length; i++) {
              ...
              itemDiv.setAttribute(
                "style",
                "display:flex;flex-direction:row;text-align:left;border:1px solid gray;border-radius: 10px;margin-top:5px;padding: 5px"
              );
              itemDiv.setAttribute("data-item", "coupon");
              itemDiv.innerHTML = `<img style="width:120px;height:100%;margin-right:10vw;display: block;" src="${item.imgUrl}" />
                  <div>
              ...
              itemDiv.addEventListener("click", (evt) => {
                ...
                if (
                  ...
                  (target.parentNode == itemDiv && target.tagName != "BUTTON")
                ) {
                  if (!item.flag) {
    ...
    11: [
      function (require, module, exports) {
        ...
        class getCouponCenter {
          constructor(couponParams, containerDiv, outputTextarea) {
            this.url =
              "https://s.m.jd.com/activemcenter/mcouponcenter/receivecoupon?coupon={actId},{ckey}&batchid={batchid}&sceneval=2&g_login_type=1";
            this.detailurl =
              "https://api.m.jd.com/client.action?functionId=getCcFeedInfo&clientVersion=8.4.6&client=android&uuid=869782023101754-c40bcb2a081c&st=1580274952976&sign=5e8edb6a1063a25d2a8d98b537974329&sv=120";
            this.couponList = [];
            this.couponParams = couponParams;
            this.container = containerDiv;
            this.outputTextarea = outputTextarea;
          ...
          get() {
            ...
            fetch(this.detailurl, {
              ...
              body:
                "body=" +
                encodeURIComponent(
                  `{"categoryId":118,"childActivityUrl":"openapp.jdmobile://virtual?params={\\"category\\":\\"jump\\",\\"des\\":\\"couponCenter\\"}","eid":"eidA34d08122basezJhsrmQRRxmKprHoj2C/qsyYbh5TyzlV40H/a8UVc9Mwqf5fJ3ez02Ja/n0hNrG4CqlQNZ5J5VyfpzABj6gCzqhlaRbPfZI81+d1","monitorRefer":"appClient","monitorSource":"ccfeed_android_index_feed","pageClickKey":"Coupons_GetCenter","pageNum":1,"pageSize":20,"shshshfpb":"hJFvGjgPo+Yfm06tQPQBhVa8JMvNh0ofLojzHNpvuXWBm0H7FUSxeyfZMVsrL7YOK"}`
                ),
              headers: {
                "Content-Type": "application/x-www-form-urlencoded",
              },
          ...
          list() {
            const content = document.createElement("div");
            content.innerHTML =
              "<h3 style='border-bottom: 1px solid #2196F3;display: inline-block;margin-top: 5px;padding: 0 37.5vw 5px;'>优惠券</h3><p style='margin: 5px 0;color:red'>请先点击列表项选择领取的券<br>【接口数据来自APP端-为你推荐】</p>";
            content.setAttribute(
              "style",
              "display:flex;flex-direction:column;padding: 5px;margin-top: 5px;border: 1px solid #000;"
            );
            for (let i = 0; i < this.couponList.length; i++) {
              ...
              itemDiv.setAttribute(
                "style",
                ";margin-top:5px;padding:10px 0;border:1px solid #999"
              );
              itemDiv.setAttribute("data-item", "coupon");
              itemDiv.innerHTML = `
          ...
          send() {
            for (let i = 0; i < this.couponList.length; i++) {
              let item = this.couponList[i],
                url = this.url
                  .replace("{actId}", item.actId)
                  .replace("{ckey}", item.ckey)
                  .replace("{batchid}", item.batchId);
              if (item.flag) {
                fetch_jsonp_1.default
                  .fetchJsonp(url)
                  .then(function (response) {
                    return response.json();
                  })
      ...
      { "../utils/fetch-jsonp": 29, "../utils/utils": 30 },
    ],
    12: [
      function (require, module, exports) {
        "use strict";
        ...
        class Mfreecoupon {
          ...
          send() {
            let url = this.url
              .replace("{key}", this.couponParams["key"])
              .replace("{roleId}", this.couponParams["roleId"]);
            utils_1.default.createJsonp(url, false);
          }
          jsonp(response) {
            utils_1.default.outPutLog(
              this.outputTextarea,
              `领券结果:${JSON.stringify(response)}`
            );
          }
        }
        ...
        class NewBabelAwardCollection {
          ...
          get() {
            ...
            for (let i = 0; i < activityData.length; i++) {
              ...
              if (
                item.template == "free_coupon" ||
                item.template == "finance_coupon" ||
                item.template == "combine_coupon"
              ) {
          ...
          list() {
            ...
            for (let i = 0; i < this.couponList.length; i++) {
              ...
              itemDiv.setAttribute(
                "style",
                "display:flex;flex-direction:row;border:1px solid gray;border-radius: 10px;margin-top:5px;padding: 5px"
              );
              itemDiv.setAttribute("data-item", "coupon");
              if (item.scene == "1") {
                itemDiv.innerHTML = `<img style="user-select: none;pointer-events:none;width:120px;height:100%;padding-right:10vw;display: block;" src="${
                  item.picUrl
                }" />
                  <div">
                      <p style="user-select: none;pointer-events:none;margin-bottom:10px">状态：${
                        item.status == "0"
                          ? "可领取"
                          : item.status == "1"
                          ? "已领取"
                          : "已领光"
                      }<br/>说明：${item.details}</p>
                      <button style="width: 100px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;">
                          <a href='https://so.m.jd.com/list/couponSearch.action?couponbatch=${
                            item.couponbatch
                          }' target="_blank" style="color: #fff;text-decoration: none;">可用商品</a>
                      </button>
                      <button style="width: 100px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;">
                          <a href='https://api.m.jd.com/client.action?functionId=newBabelAwardCollection&body={"activityId":"${
                            this.couponParams.activityId
                          }","scene":${item.scene},"args":"${
                  item.args
                }"}&client=wh5' target="_blank" style="color: #fff;text-decoration: none;">提取链接</a>
                      </button>
                  </div>`;
                ...
                fetch(url, { credentials: "include" })
                  ...
                  .then((json) => {
                    if (json.errmsg) {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `第${i + 1}张 领券结果:${json.errmsg}`
                      );
                    } else {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `第${i + 1}张 领券结果:${json.subCodeMsg}`
                      );
                    }
                  });
              }
        ...
        class Purchase {
          constructor(couponParams, containerDiv, outputTextarea) {
            this.url =
              "https://vip.jr.jd.com/goldcoin/purchase?id={pid}&callback=";
            this.detailurl =
              "https://vip.jr.jd.com/goldcoin/product/{pid}?callback=";
            this.couponList = [];
            this.couponParams = couponParams;
            this.container = containerDiv;
            this.outputTextarea = outputTextarea;
      ...
      function (require, module, exports) {
        ...
        class ReceiveCoupon {
          constructor(couponParams, containerDiv, outputTextarea) {
            ...
            this.detailurl =
              "https://ms.jr.jd.com/gw/generic/bt/h5/m/queryBtmLimitedInfo";
            this.couponList = [];
            this.couponParams = couponParams;
            this.container = containerDiv;
            this.outputTextarea = outputTextarea;
              ...
              if (item.flag) {
                fetch(url, { credentials: "include" })
                  ...
                  .then((json) => {
                    utils_1.default.outPutLog(
                      this.outputTextarea,
                      `领券结果:${JSON.stringify(json.resultData)}`
                    );
                  });
              }
            }
      ...
      function (require, module, exports) {
        ...
        class ReceiveCoupons {
          constructor(couponParams, containerDiv, outputTextarea) {
            ...
            this.detailurl =
              "https://ms.jr.jd.com/gw/generic/bt/h5/m/queryLimitedInfo?callback=";
            this.couponList = [];
            this.couponParams = couponParams;
            this.container = containerDiv;
            this.outputTextarea = outputTextarea;
    ...
    17: [
      function (require, module, exports) {
        ...
        class ReceiveDayCoupon {
          constructor(couponParams, containerDiv, outputTextarea) {
            this.url =
              "https://rsp.jd.com/coupon/receiveDayCoupon/v1?locationCode=10002&lt=m&an=plus.mobile&getType=1&discount=10&couponKey=&platform=3&eventId=MPlusCoupon_Get&eid=&fp=&getType=1&activityId={activityId}";
            this.detailurl =
              "https://rsp.jd.com/coupon/dayCouponList/v1/?lt=m&an=plus.mobile&couponType=0_1";
            this.couponList = [];
            this.couponParams = couponParams;
            this.container = containerDiv;
            this.outputTextarea = outputTextarea;
          ...
          list() {
            const content = document.createElement("div");
            content.innerHTML =
              "<h3 style='border-bottom: 1px solid #2196F3;display: inline-block;margin-top: 5px;padding: 0 37.5vw 5px;'>优惠券</h3><p style='margin: 5px 0;color:red'>点击列表项选择要领取的券</p>";
            content.setAttribute(
              "style",
              "display:flex;flex-direction:column;padding: 5px;margin-top: 5px;border: 1px solid #000;"
            );
            for (let i = 0; i < this.couponList.length; i++) {
              ...
              itemDiv.setAttribute(
                "style",
                "text-align:left;border:1px solid gray;border-radius: 10px;margin-top:5px;padding: 5px"
              );
              itemDiv.setAttribute("data-item", "coupon");
              itemDiv.innerHTML = `<h3 style="user-select: none;pointer-events:none;">折扣：${
                item.quota
              }-${item.discount}</h3>
                                      <p style="margin-bottom:10px;user-select: none;pointer-events:none;">状态：${
                                        item.couponState == 1
                                          ? "可领取"
                                          : item.couponState == 6
                                          ? "已领光"
                ...
                item.limitStr
              }<br/>兑换礼金：${item.giftAmount}<br/>领取时间：${
                item.hour || "现在可领"
              }</p>
              ...
              if (item.flag) {
                fetch(url, { credentials: "include" })
                  ...
                  .then((json) => {
                    utils_1.default.outPutLog(
                      this.outputTextarea,
                      `${item.quota}-${item.discount} 领券结果:${json.msg}`
                    );
                  });
              }
            }
    ...
    18: [
      function (require, module, exports) {
        ...
        class ReceiveSeckillReward {
          constructor(couponParams, containerDiv, outputTextarea) {
            this.getInfoURL =
              "https://ms.jr.jd.com/gw/generic/uc/h5/m/getSeckillInfo";
        ...
        class SecKillCoupon {
          constructor(couponParams, containerDiv, outputTextarea) {
            this.url =
              "https://api.m.jd.com/client.action?functionId=newBabelAwardCollection";
            this.detailurl =
              "https://api.m.jd.com/client.action?functionId=getBillionSubsidyInfo&body=%7B%22source%22:%22home_subsidy%22%7D&appid=XPMSGC2019";
            this.couponList = [];
            this.couponParams = couponParams;
            this.container = containerDiv;
            this.outputTextarea = outputTextarea;
          ...
          list() {
            ...
            for (let i = 0; i < this.couponList.length; i++) {
              ...
              itemDiv.setAttribute(
                "style",
                "display:flex;flex-direction:row;padding:10px 0;border:1px solid gray;border-radius: 10px;margin-top:5px;padding: 5px"
              );
              itemDiv.setAttribute("data-item", "coupon");
          ...
          send() {
            for (let i = 0; i < this.couponList.length; i++) {
              let item = this.couponList[i];
              if (item.flag) {
                const url = `https://api.m.jd.com/client.action?functionId=receiveSeckillCoupon&body=%7B"roleId"%3A"${encodeURIComponent(
                  item["putKey"]
                )}"%2C"source"%3A"home_subsidy"%2C"floorType"%3A0%2C"skuId"%3A"${
                  item.skuId
                }"%2C"quota"%3A"${item.quota}"%2C"disCount"%3A"${
                  item.discount
                }"%2C"batchId"%3A"${
                  item.batchId
                }"%7D&client=m&appid=XPMSGC2019`;
                fetch(url, {
                  method: "POST",
                  mode: "cors",
                  credentials: "include",
                  ...
                  .then((json) => {
                    utils_1.default.outPutLog(
                      this.outputTextarea,
                      `${item.quota}-${item.discount} 领券结果:${json.resultMsg}`
                    );
                  });
              }
            }
          ...
          singleSend(index) {
            let item = this.couponList[index],
              url = `https://api.m.jd.com/client.action?functionId=receiveSeckillCoupon&body=%7B"roleId"%3A"${encodeURIComponent(
                item["putKey"]
              )}"%2C"source"%3A"home_subsidy"%2C"floorType"%3A0%2C"skuId"%3A"${
                item.skuId
              }"%2C"quota"%3A"${item.quota}"%2C"disCount"%3A"${
                item.discount
              }"%2C"batchId"%3A"${item.batchId}"%7D&client=m&appid=XPMSGC2019`;
            fetch(url, {
              method: "POST",
              mode: "cors",
              credentials: "include",
    ...
    20: [
      function (require, module, exports) {
        ...
        class WhiteCoupon {
          constructor(couponParams, containerDiv, outputTextarea) {
            this.url =
              "https://opencredit.jd.com/act/get/coupon?couponBusinessId={couponBusinessId}&actId=004";
            this.detailurl =
              "https://opencredit.jd.com/act/get/couponInfo?couponBusinessId={couponBusinessId}";
            this.couponList = [];
            this.couponParams = couponParams;
            this.container = containerDiv;
            this.outputTextarea = outputTextarea;
          ...
          get() {
            ...
            let url = this.detailurl.replace(
              "{couponBusinessId}",
              this.couponParams.couponBusinessId
            );
            fetch(url)
              .then((res) => {
                return res.json();
              ...
              .then((json) => {
                ...
                if (json.isSuccess) {
                  this.couponList.push({
                    couponBusinessId: JSON.parse(json["data"])[
                      "baiCouponDetailsNext"
                    ].couponBusinessId,
          ...
          list() {
            const content = document.createElement("div");
            content.innerHTML =
              "<h3 style='border-bottom: 1px solid #2196F3;display: inline-block;margin-top: 5px;padding: 0 37.5vw 5px;'>优惠券</h3><p style='margin: 5px 0;color:red'>默认领取单张券，无须选定</p>";
            content.setAttribute(
              "style",
              "display:flex;flex-direction:column;padding: 5px;margin-top: 5px;border: 1px solid #000;"
            );
    ...
    24: [
      function (require, module, exports) {
        ...
        class BTGoose {
          ...
          <div>`;
            ...
            const d = utils_1._$(".toDailyHome"),
              g = utils_1._$(".toGoldExchange"),
              autoToWithdraw = utils_1._$(".autoToWithdraw"),
              cancelautoToWithdraw = utils_1._$(".cancelautoToWithdraw"),
              t = utils_1._$(".toWithdraw");
                ...
                if (res.resultCode == 0) {
                  ...
                  if (data.code == "0000") {
                    ...
                    if (config_1.default.multiFlag && ckObj) {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `【${ckObj["mark"]}】 收蛋成功！当前鹅蛋数量：${eggTotal}`
                      );
                    } else {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `收蛋成功！当前鹅蛋数量：${eggTotal}`
                      );
                    }
                  } else {
                    utils_1.default.outPutLog(
              ...
              .then((res) => {
                if (res.resultCode == 0) {
                  ...
                  if (config_1.default.multiFlag && ckObj) {
                    utils_1.default.outPutLog(
                      this.outputTextarea,
                      `【${ckObj["mark"]}】 可兑换：${availableTotal} 未收取：${grassEggTotal} 可容纳：${basketSize} `
                    );
                  } else {
                    utils_1.default.outPutLog(
                      this.outputTextarea,
                      ` 可兑换：${availableTotal} 未收取：${grassEggTotal} 可容纳：${basketSize} `
                    );
                  }
                } else {
                  utils_1.default.outPutLog(
                ...
                if (res.resultCode == 0) {
                  if (res.resultData.code == "0000") {
                    ...
                    if (config_1.default.multiFlag && ckObj) {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `【${ckObj["mark"]}】 已兑换:${cnumber} 比例：${rate} 总金币：${goldTotal}`
                      );
                    } else {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `已兑换:${cnumber} 比例：${rate} 总金币：${goldTotal}`
                      );
                    }
                  } else {
                    utils_1.default.outPutLog(
      ...
      {
        "../config/config": 5,
        "../cookie/CookieHandler": 6,
        "../cookie/CookieManager": 7,
        "../utils/utils": 30,
      },
    ],
    25: [
      function (require, module, exports) {
        ...
        class Cloudpig {
          constructor(params, containerDiv, outputTextarea) {
            ...
            this.detailurl =
              "https://api.m.jd.com/client.action?functionId=bombnian_getTaskDetail";
            this.data = [];
            this.timer = 1000;
            this.taskToken = "";
            this.favFoodMap = {
              ...
              __awaiter(this, void 0, void 0, function* () {
                ...
                do {
                  if (config_1.default.multiFlag) {
                    ...
                    if (
                      CookieManager_1.default.cookieArr.every((i) => {
                        return !i["flag"];
                      })
                    ) {
                      this.openBoxFlag = false;
                            ...
                            if (!item["flag"]) {
                              ...
                              yield fetch(`${this.rootURI}${url}`, {
                                ...
                                body:
                                  "reqData=" +
                                  JSON.stringify(
                                    Object.assign(this.baseReqData, {
                                ...
                                .then((res) => {
                                  ...
                                  if (res.resultCode == 0) {
                                    ...
                                    if (resultCode == 0) {
                                      ...
                                      utils_1.default.outPutLog(
                                        this.outputTextarea,
                                        `【${item["mark"]}】:今天已经木有开盒子机会了~`
                                      );
                                    }
                                  } else {
                                    utils_1.default.outPutLog(
                                      this.outputTextarea,
                                      `【${item["mark"]}】:${res.resultMsg}`
                                    );
                                  }
                                  resolve();
                                });
                            ...
                            if (res.resultData.resultCode == 0) {
                              ...
                              utils_1.default.outPutLog(
                                ...
                                `${
                                  (
                                    (_b =
                                      (_a = result) === null || _a === void 0
                                        ? void 0
                                        : _a.award) === null || _b === void 0
                                      ? void 0
                                      : _b.name
                                  )
                                    ? "获得:" +
                                      ((_d =
                                        (_c = result) === null || _c === void 0
                                          ? void 0
                                          : _c.award) === null || _d === void 0
                                        ? void 0
                                        : _d.name)
                                    : "这是个空箱子"
                                }`
          ...
          addFood(favBool = false, ckObj) {
            let skuId = ckObj
              ? favBool
                ...
                : this.foodskuId
              : favBool
              ? this.favFoodMap[this.favoriteFood]
              : this.foodskuId;
            fetch(this.rootURI + "pigPetAddFood", {
              ...
              body:
                "reqData=" +
                JSON.stringify(
                  Object.assign(this.baseReqData, { skuId: skuId })
                ),
            })
              .then(function (response) {
                return response.json();
                ...
                if (res.resultCode == 0) {
                  ...
                  if (data.hasPig) {
                    ...
                    let pig =
                        (_b =
                          (_a = data) === null || _a === void 0
                            ? void 0
                            : _a.cote) === null || _b === void 0
                          ? void 0
                          : _b.pig,
                      pigName =
                        (_c = pig) === null || _c === void 0
                          ? void 0
                          : _c.pigName,
                      percent = pig.percent,
                      weight = pig.weight,
                    ...
                    if (config_1.default.multiFlag && ckObj) {
                      ...
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `【${ckObj["mark"]}】 猪猪：${pigName} 价值：${percent}% 体重：${weight} 喜欢：${favFood}`
                      );
                    } else {
                      this.favoriteFood = favFood;
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `猪猪：${pigName} 价值：${percent}% 体重：${weight} 喜欢：${favFood}`
                      );
                    }
                  } else {
                    utils_1.default.outPutLog(
                    ...
                    let currentCount =
                      ...
                      coinCount =
                        (_b = data) === null || _b === void 0
                          ...
                          : _b.coinCount,
                      price =
                        (_c = data) === null || _c === void 0
                          ? void 0
                          : _c.price,
                      nextFreeTime =
                        (_d = data) === null || _d === void 0
                          ? void 0
                          : _d.nextFreeTime;
                    if (config_1.default.multiFlag && ckObj) {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `【${ckObj["mark"]}】 当前可抽奖次数：${currentCount} 距下一次免费抽奖时间：${nextFreeTime}毫秒 金币抽奖次数：${coinCount} 需花费金币：${price}`
                      );
                    } else {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `当前可抽奖次数：${currentCount} 距下一次免费抽奖时间：${nextFreeTime}毫秒 金币抽奖次数：${coinCount} 需花费金币：${price}`
                      );
                    }
                  } else {
                    utils_1.default.outPutLog(
            ...
            fetch(
                ...
                utils_1.default.getTimestamp(),
              {
                ...
                body:
                  ...
                  JSON.stringify(
                    Object.assign(this.baseReqData, {
                      no: ckObj ? ckObj.signNo : this.signNo,
                    })
                  ),
              }
            )
                    ...
                    let today =
                      ...
                      name =
                        (_c =
                          (_b = data) === null || _b === void 0
                            ? void 0
                            : _b.award) === null || _c === void 0
                          ? void 0
                          : _c.name;
                    if (config_1.default.multiFlag && ckObj) {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `【${ckObj["mark"]}】 已签到${today}天 获得奖励：${name}`
                      );
                    } else {
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `已签到${today}天 获得奖励：${name}`
                      );
                    }
                  } else {
                    utils_1.default.outPutLog(
            ...
            fetch(
              ...
              .then((res) => {
                ...
                if (res.resultCode == 0) {
                  ...
                  if (res.resultData.resultCode == 0) {
                    let today =
                      (_a = data) === null || _a === void 0 ? void 0 : _a.today;
                    if (config_1.default.multiFlag && ckObj) {
                      ckObj.signNo = today;
                      utils_1.default.outPutLog(
                        this.outputTextarea,
                        `【${ckObj["mark"]}】 已签到${today}天 `
                      );
                      this.signOne(ckObj);
                    } else {
                      this.signNo = today;
            ...
            fetch(
                ...
                utils_1.default.getTimestamp(),
              {
                ...
                body:
                  "reqData=" +
                  JSON.stringify(
                    Object.assign(this.baseReqData, { category: "1001" })
                  ),
              }
            )
              .then(function (response) {
          ...
          lottery(ckObj) {
            fetch(
              this.rootURI +
                ...
                encodeURI(
                  JSON.stringify(
                    Object.assign({ t: new Date().getTime() }, this.baseReqData)
                  )
                ),
              {
                mode: "no-cors",
      ...
      function (require, module, exports) {
        ...
        class Goods {
          constructor(containerDiv, outputTextarea, goodsId) {
            ...
            this.stockURL =
              "https://c0.3.cn/stock?skuId={skuId}&area={area}&venderId={venderId}&cat={cat}";
            if (goodsId) {
            ...
            //获取默认地址
            fetch_jsonp_1.default
              .fetchJsonp("https://cd.jd.com/usual/address")
              .then((res) => {
                return res.json();
              })
              .then((json) => {
                if (Object.keys(json).length !== 0) {
                  ...
                  Object.keys(json).map((key, idx) => {
                    let item = json[key];
                    let id = `${item.provinceId}_${item.cityId}_${
                        item.countyId ? item.countyId : 0
                      }_${item.townId ? item.townId : 0}`,
                      dec = item.areaName;
                    if (idx == 0) {
                      this.areaId = id;
                    }
          ...
          get() {
            this.goodsMsgArr = [];
            Promise.all(
              this.goodsIdArr.map((item) => {
                return this.getMsg(item);
              })
            ).then((data) => {
              this.goodsMsgArr = data;
              Promise.all(
                this.goodsMsgArr.map((item) => {
          ...
          getMsg(skuid) {
            ...
            return new Promise((resolve, reject) => {
              utils_1.default.loadiFrame(url).then((iframe) => {
          ...
          getStock(goods) {
            let url = this.stockURL
              .replace("{skuId}", goods.skuid)
              .replace("{venderId}", goods.venderId)
              .replace("{cat}", goods.cat)
              .replace("{area}", this.areaId);
            return new Promise((resolve, reject) => {
              fetch_jsonp_1.default
                .fetchJsonp(url)
                .then(function (response) {
    ...
    28: [
      function (require, module, exports) {
        ...
        const container = document.createElement("div"),
          UATipsDiv = document.createElement("div"),
        ...
        function buildOperate() {
          operateAreaDiv.setAttribute(
            "style",
            "border: 1px solid #000;margin: 10px 0;"
          );
          operateAreaDiv.innerHTML =
            "<h3 style='border-bottom: 1px solid #2196F3;display: inline-block;margin: 5px;padding: 0 25vw 5px;'>操作区</h3>";
          if (coupon) {
            buildTimerControl();
          }
          loginMsgDiv.innerHTML =
            "当前京东帐号：<a href='https://plogin.m.jd.com/login/login' target='_blank'>点击登录</a>";
        ...
        function buildOutput() {
          ...
          outputTextArea.setAttribute(
            "style",
            "width: 90vw;height: 40vw;border: 1px solid #868686;border-radius: 10px;overflow-y: scroll;margin:5px auto;"
          );
          ...
          clearOutLogBtn.setAttribute(
            "style",
            "width: 120px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;color:#fff;margin:5px;"
          );
        ...
        function buildTimerControl() {
          ...
          timerTextInput.setAttribute(
            "style",
            "width:80vw;height: 25px;border: solid 1px #000;border-radius: 5px;margin: 10px auto;display: block;"
          );
          timerResetBtn.innerHTML = "重置刷新频率";
          timerResetBtn.setAttribute(
            "style",
            "width: 120px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;color:#fff;"
          );
          timerResetBtn.addEventListener("click", () => {
            ...
            config_1.default.intervalId = window.setInterval(
              getTime,
              config_1.default.intervalSpan
            );
          });
          ...
          receiveTextInput.placeholder =
            "定时领券时间【格式:2020-01-01 09:59:59:950】";
          receiveTextInput.setAttribute(
            "style",
            "width:80vw;height: 25px;border: solid 1px #000;border-radius: 5px;margin: 10px;"
          );
          receiveCountInput.type = "text";
          receiveCountInput.placeholder = "领券提交次数【默认：1次】";
          receiveCountInput.setAttribute(
            "style",
            "width:80vw;height: 25px;border: solid 1px #000;border-radius: 5px;margin: 10px;"
          );
          spanTextInput.type = "text";
          spanTextInput.placeholder =
            "请输入重复领券的提交频率【默认：500毫秒】";
          spanTextInput.setAttribute(
            "style",
            "width:80vw;height: 25px;border: solid 1px #000;border-radius: 5px;margin: 10px auto;display: block;"
          );
          receiveTimerBtn.innerHTML = "定时指定领取";
          receiveTimerBtn.addEventListener("click", () => {
            config_1.default.postSpan =
              parseInt(spanTextInput.value) > 0
                ? parseInt(spanTextInput.value)
                : 500;
            config_1.default.postCount =
              parseInt(receiveCountInput.value) > 0
                ? parseInt(receiveCountInput.value)
                : 1;
            ...
            if (!time || time < 0) {
              ...
              if (config_1.default.timingFlag) {
                ...
                utils_1.default.outPutLog(
                  outputTextArea,
                  `已开启定时领取！定时领取时间：${receiveTextInput.value}`
                );
              } else {
                receiveTimerBtn.innerHTML = "定时指定领取";
          ...
          receiveTimerBtn.setAttribute(
            "style",
            "width: 120px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;color:#fff;margin:5px;"
          );
          receiveAllBtn.innerHTML = "一键指定领取";
          receiveAllBtn.setAttribute(
            "style",
            "width: 120px;height:30px;background-color: #2196F3;border-radius: 5px;border: 0;color:#fff;margin:5px;"
          );
        ...
        function buildTips() {
          ...
          tips.innerHTML =
            '<h4>页面地址暂未被扩展或者有误！</h4><p>本插件只能在指定活动地址或领券地址使用！</p><p>如果这是个活动地址或领券地址，<a href="tencent://message/?uin=708873725Menu=yes" target="_blank" title="发起QQ聊天">联系作者</a>扩展~</p><a style="color:red" onclick=Utils.copyText(Config.NetdiskURL)>点击下载教程视频</a>';
          title.append(tips);
        }
        function buildTitle() {
          ...
          container.setAttribute(
            "style",
            "border: 1px solid #000;margin: 10px 0;padding: 5px;margin: 5px;"
          );
      ...
      <hr style="margin: 10px;"><div class="activityExtensionDiv"></div>`;
          ...
          utils_1._$("#import").addEventListener("click", () => {
            utils_1.default.importFile("text/plain").then((ck) =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                if (config_1.default.importFlag) {
                  ...
                  Promise.all(
                    CookieManager_1.default.cookieArr.map((item) => {
                      return CookieManager_1.default.checkLogin(
                        outputTextArea,
                        item
                      );
                    })
          ...
          utils_1._$(".activity-list").addEventListener("click", (e) => {
            ...
            if (target.getAttribute("class") == "pig") {
              if (!gameMap.Cloudpig) {
                gameMap.Cloudpig = new cloudpig_1.default(
                  null,
                  activityExtensionDiv,
                  outputTextArea
                );
              ...
              if (!gameMap.BTGoose) {
                gameMap.BTGoose = new btgoose_1.default(
                  null,
                  activityExtensionDiv,
                  outputTextArea
                );
              ...
              if (!gameMap.signInCenter) {
                gameMap.signInCenter = new signInCenter_1.default(
                  null,
                  activityExtensionDiv,
                  outputTextArea
                );
        ...
        function buildTimeoutArea() {
          ...
          timeoutInput.setAttribute(
            "style",
            "width:80vw;height: 25px;font-size:14px;border: solid 1px #000;border-radius: 5px;margin: 10px auto;display: block;"
          );
        ...
        function getEntryType() {
          ...
          if (
            config_1.default.locationHref.includes("item.jd.com/") ||
            config_1.default.locationHref.includes("item.m.jd.com/product/")
          ) {
          ...
          if (window.__react_data__) {
            ...
            config_1.default.locationHref.includes(
              "gcmall/index.html#/details?pid="
            )
          ) {
            type = couponType_1.couponType.purchase;
          } else if (
            config_1.default.locationHref.includes(
              "member/gcmall/index.html#/details?gid"
            )
          ) {
            type = couponType_1.couponType.coinPurchase;
          } else if (
            config_1.default.locationHref.includes("plus.m.jd.com/coupon/")
          ) {
            ...
            /babelDiy\/(\S*)\/index/.test(config_1.default.locationHref)
          ) {
            type = couponType_1.couponType.secKillCoupon;
          } else if (
            /coupons\/show.action\?key=(\S*)&roleId=(\S*)/.test(
              config_1.default.locationHref
            )
          ) {
            type = couponType_1.couponType.mfreecoupon;
          } else if (
            config_1.default.locationHref.includes(
              "m.jr.jd.com/member/rightsCenter/#/white"
            )
          ) {
            type = couponType_1.couponType.ReceiveCoupons;
          } else if (
            config_1.default.locationHref.includes(
              "m.jr.jd.com/consumer/baitiaom/index.html"
            )
          ) {
            type = couponType_1.couponType.ReceiveCoupon;
          } else if (
            config_1.default.locationHref.includes(
              "coupon.m.jd.com/center/getCouponCenter.action"
            )
          ) {
            type = couponType_1.couponType.getCouponCenter;
          } else if (
            config_1.default.locationHref.includes(
              "vip.m.jd.com/index.html?appName=fuli&id="
            )
          ) {
        ...
        function getEntryDesc(type) {
          ...
          switch (type) {
            ...
            case couponType_1.couponType.whiteCoupon:
              const couponBusinessId = utils_1.default.GetQueryString(
                "couponBusinessId"
              );
            ...
            case couponType_1.couponType.receiveDayCoupon:
              coupon = new receiveDayCoupon_1.default(
                null,
                container,
                outputTextArea
              );
            ...
            case couponType_1.couponType.secKillCoupon:
              coupon = new secKillCoupon_1.default(
                null,
                container,
                outputTextArea
              );
            ...
            case couponType_1.couponType.mfreecoupon:
              ...
              coupon = new mfreecoupon_1.default(
                { roleId: roleId, key: key },
                container,
                outputTextArea
              );
              break;
            case couponType_1.couponType.ReceiveCoupons:
              coupon = new receiveCoupons_1.default(
                null,
                container,
                outputTextArea
              );
            ...
            case couponType_1.couponType.ReceiveCoupon:
              coupon = new receiveCoupon_1.default(
                null,
                container,
                outputTextArea
              );
            ...
            case couponType_1.couponType.getCouponCenter:
              coupon = new getCouponCenter_1.default(
                null,
                container,
                outputTextArea
              );
            ...
            case couponType_1.couponType.receiveSeckillReward:
              coupon = new receiveSeckillReward_1.default(
                null,
                container,
                outputTextArea
              );
          ...
          if (isJDcontext) {
            ...
            buildOperate();
            // buildExtensionTab();
            utils_1.default.createJsonp(
              `${config_1.default.JDUserInfoURL}&callback=getLoginMsg`
            );
          }
          if (coupon) {
            config_1.default.intervalId = window.setInterval(
        ...
        function getTime() {
          fetch(config_1.default.JDTimeInfoURL)
            ...
            .then(function (res) {
              config_1.default.serverTime = utils_1.default.formatDate(
                res.time
              );
              config_1.default.localeTime =
                new Date(+res.time).toLocaleString() +
                ":" +
                config_1.default.serverTime.substr(-3, 3);
              timerTittleDiv.innerHTML = `京东时间：${config_1.default.localeTime}<br/>当前获取时间的间隔频率：${config_1.default.intervalSpan}毫秒`;
              if (config_1.default.timingFlag) {
                if (
                  config_1.default.startTime <= +config_1.default.serverTime
                ) {
                  utils_1.default.outPutLog(outputTextArea, `定时领取开始！`);
                  utils_1.default.outPutLog(
                    outputTextArea,
                    `当前京东服务器时间：${config_1.default.localeTime}`
                  );
                  config_1.default.timingFlag = !config_1.default.timingFlag;
                  if (coupon) {
        ...
        function copyRights() {
          ...
          if (window.console) {
            console.group(
              "%c京东领券助手",
              "color:#009a61; font-size: 36px; font-weight: 400"
            );
            console.log(
              "%c本插件仅供学习交流使用\n作者:krapnik \n既然按了F12，为何不去GitHub顺便给个star\ngithub:https://github.com/krapnikkk/JDCouponAssistant",
              "color:#009a61"
            );
            console.groupEnd();
          }
        ...
        function statistical() {
          (function () {
            ...
            hm.src =
              "https://hm.baidu.com/hm.js?d86d4ff3f6d089df2b41eb0735194c0d";
      ...
      {
        "./activitys/guardianstar": 1,
        "./activitys/stall": 2,
        "./activitys/starMall": 3,
        "./activitys/timeMachine": 4,
        "./config/config": 5,
        "./cookie/CookieHandler": 6,
        "./cookie/CookieManager": 7,
        "./coupons/coinPurchase": 8,
        "./coupons/exchange": 9,
        "./coupons/gcConvert": 10,
        "./coupons/getCouponCenter": 11,
        "./coupons/mfreecoupon": 12,
        "./coupons/newBabelAwardCollection": 13,
        "./coupons/purchase": 14,
        "./coupons/receiveCoupon": 15,
        "./coupons/receiveCoupons": 16,
        "./coupons/receiveDayCoupon": 17,
        "./coupons/receiveSeckillReward": 18,
        "./coupons/secKillCoupon": 19,
        "./coupons/whtieCoupon": 20,
        "./enum/activityType": 21,
        "./enum/couponType": 22,
        "./enum/goodsType": 23,
        "./game/btgoose": 24,
        "./game/cloudpig": 25,
        "./game/signInCenter": 26,
        "./goods/goods": 27,
        "./utils/utils": 30,
      },
    ],
      ...
      function (require, module, exports) {
        ...
        class FetchJsonp {
          ...
          static fetchJsonp(_url, options = {}) {
            ...
            let url = _url;
            const timeout =
              options.timeout || FetchJsonp.defaultOptions.timeout;
            const jsonpCallback =
              options.jsonpCallback || FetchJsonp.defaultOptions.jsonpCallback;
            let timeoutId;
            return new Promise((resolve, reject) => {
              const callbackFunction =
                options.jsonpCallbackFunction ||
                FetchJsonp.generateCallbackFunction();
        ...
        class Utils {
          ...
          static GetQueryString(name) {
            ...
            if (!r) {
              ...
              r = url
                .substr(url.indexOf("?") + 1, url.length - url.indexOf("?"))
                .match(reg);
            }
          ...
          static getQueryStringByName(url) {
            ...
            var queryString = /\?[a-zA-Z0-9\=\&\%\$\-\_\.\+\!\*\'\(\)\,]+/.exec(
              url
          ...
          static request(functionId, body = {}) {
            return fetch(
              `https://api.m.jd.com/client.action?functionId=${functionId}`,
              {
